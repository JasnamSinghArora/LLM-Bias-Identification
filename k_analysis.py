...
def plot_mean_bias_score():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(constants["RUN_DIR"], "k_mean_bias_score.png"), dpi=150)
    plt.close()
...
def plot_marginal_gain():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(constants["RUN_DIR"], "k_marginal_gain.png"), dpi=150)
    plt.close()
...
def plot_bell_curves():
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(os.path.join(constants["RUN_DIR"], "k_bell_curves.png"), dpi=150)
    plt.close()
...
def plot_individual_bell_curves():
    ...
    plt.savefig(os.path.join(constants["RUN_DIR"], "k_bell_curves_individual.png"), dpi=150)
    plt.close()


def run_all():
    plot_mean_bias_score()
    plot_marginal_gain()
    plot_bell_curves()
